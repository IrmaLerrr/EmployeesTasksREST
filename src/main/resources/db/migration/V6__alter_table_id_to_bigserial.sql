...
CREATE SEQUENCE employee_id_seq AS BIGINT START WITH 0 MINVALUE 0 OWNED BY employee.id;
...
CREATE SEQUENCE task_id_seq AS BIGINT START WITH 0 MINVALUE 0 OWNED BY task.id;
